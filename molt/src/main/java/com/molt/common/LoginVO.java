...
public class LoginVO implements Serializable{
	...
	/** 서비스id*/
	@NotNull(message="서비스ID는 필수입력항목입니다.")
	private String svcId;
	/** 사용자유형*/
	@NotNull(message="사용자유형은 필수입력항목입니다.")
	private String userTy;
	/** 아이디 */
	@NotNull(message="아이디는 필수입력항목입니다.")
	@Email(message="로그인 정보가 존재하지 않습니다.(ID)")
	private String id;
	/** 이름 */
	private String name;
	/** 주민등록번호 */
	...
	/** 비밀번호 */
	@NotNull(message="비밀버호는 필수입력항목입니다.")
	@Pattern(regexp="((?=.*\\d)(?=.*[a-z])(?=.*[1-9]).{8,20})", message="로그인 정보가 존재하지 않습니다.(PW)")
