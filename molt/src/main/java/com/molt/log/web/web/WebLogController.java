...
import com.molt.common.annotation.IncludedInfo;
...
public class WebLogController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="웹로그관리", listUrl="/sym/log/wlg/SelectWebLogList.ok", order = 1070 ,gid = 60)
	@RequestMapping(value="/sym/log/wlg/SelectWebLogList.ok")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/wlg/InqireWebLog.ok")
